export const BIRD_STATS: Record<string, {
  ...
  peacock:    { damage: 20, range: 2.1, fireRate: '1.0/s', attack: 'SPLASH', cost:  90, color: '#c084fc' },
  falcon:     { damage: 50, range: 3.6, fireRate: '0.9/s', attack: 'SINGLE', cost:  50, color: '#f97316' },
  kingfisher: { damage: 20, range: 2.4, fireRate: '3.0/s', attack: 'SPLASH', cost:  50, color: '#06b6d4' },
  phoenix:    { damage: 25, range: 3.0, fireRate: '0.8/s', attack: 'SPLASH', cost:  50, color: '#ef4444' },
  sun_god:    { damage: 35, range: 3.6, fireRate: '1.6/s', attack: 'SPLASH', cost: 150, color: '#eab308' },
};
