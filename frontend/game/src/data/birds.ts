export const BIRD_STATS: Record<string, {
  ...
  falcon:     { damage: 24, range: 6.0, fireRate: '0.9/s', attack: 'SINGLE', cost:   0, color: '#f97316' },
  kingfisher: { damage:  9, range: 4.0, fireRate: '3.0/s', attack: 'SPLASH', cost:   0, color: '#06b6d4' },
  phoenix:    { damage: 28, range: 6.5, fireRate: '0.8/s', attack: 'SPLASH', cost:   0, color: '#ef4444' },
  sun_god:    { damage: 32, range: 7.0, fireRate: '1.6/s', attack: 'SPLASH', cost:   0, color: '#eab308' },
};
